...
* Ran the Lighthouse report on Chrome, with the following results: Performance: 95, Accessibility: 95, Best practices: 79, SEO: 96. Details of Lighthouse report confirmed that any issues were minor and not significantly affecting overall user experience or website performance
